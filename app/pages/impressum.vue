  ...
  <div>
    ...
    <section class="bg-primary-50 py-12">
      <UContainer>
        ...
        <p class="text-muted">
          Angaben gemäß § 5 TMG und verantwortliche Stellen
        </p>
      </UContainer>
    </section>
      ...
      <div class="prose prose-neutral dark:prose-invert max-w-none space-y-10">
        <section>
          ...
          <p class="text-muted">
            ...
            Thomas Holstein-Diepold und Dr. med. Katharina Diepold<br>
        ...
        <section>
          ...
          <p class="text-muted">
            – Berufsordnung der Landesärztekammer Niedersachsen<br>
            – Heilberufegesetz des Landes Niedersachsen<br>
            (Die Regelungen finden sich auf der Homepage der Ärztekammer Niedersachsen unter dem Stichpunkt „Beratung".)
          </p>
        </section>
        ...
        <section>
          ...
          <p class="text-muted">
            Gemäß § 55 Abs. 2 RStV: Th. Holstein-Diepold (Anschrift wie oben)
          </p>
        </section>
        ...
        <section>
          ...
          <h3 class="mb-2 mt-6 text-lg font-medium text-foreground">
            Haftung für Inhalte
          </h3>
          <p class="text-muted">
