  ...
  <div>
    <section class="bg-primary-50 py-12">
      <UContainer>
        ...
        <p class="text-muted">
          Informationen zum Datenschutz und zum Umgang mit Ihren personenbezogenen Daten
        </p>
      </UContainer>
    </section>

    <UContainer class="py-10">
      <div class="prose prose-neutral dark:prose-invert max-w-none space-y-10">
        <p class="text-muted">
        ...
        <section>
          ...
          <p class="text-muted">
            Thomas Holstein-Diepold<br>
            Albert-Schweitzer-Weg 7<br>
            D-37154 Northeim
          </p>
        ...
        <section>
          <p class="text-muted">
            ...
            Die Datenspeicherung erfolgt nach den Vorgaben der Datenschutzgrundverordnung.
        ...
        <section>
          <h2 class="mb-4 text-xl font-semibold text-foreground">
            Einbindung von Diensten und Inhalten Dritter / Externe Links
          </h2>
          <p class="text-muted">
          ...
          <p class="mt-4 text-muted">
            Unser Onlineangebot enthält zudem Links zu externen Webseiten Dritter (z.B. zur Terminbuchung, zu Patienteninformationen oder zu Informationsangeboten). Beim Aufruf dieser Links verlassen Sie unsere Seite; für die dort angebotenen Dienste und den Umgang mit Ihren Daten sind die jeweiligen Anbieter und deren Datenschutzerklärungen verantwortlich.
          </p>
        </section>
